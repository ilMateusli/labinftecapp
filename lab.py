...
if st.button("Detalhar"):
  ...
  prompt="Lista:\n"+texto_quebrado+"\n'''\nFale sobre as características do vírus da lista (nome científico ou a qual família pertence, envelope, diametro, se é RNA ou DNA, sua replicação, informações do genoma.), se for sintomas, busque o vírus que mais se aproxima aos sintomas dados na lista e mostre os motivos da escolha:\n\n Bom.",
  temperature=0.5,
  max_tokens=200,
  top_p=1,
  frequency_penalty=0,
